...
const socialLinks = [
  {
    label: 'Follow VELTRICKS on LinkedIn',
    href: 'https://linkedin.com/company/VELTRICKS',
    icon: (
  ...
  {
    label: 'Follow VELTRICKS on GitHub',
    href: 'https://github.com/VELTRICKS',
    icon: (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Follow VELTRICKS on Twitter/X',
    href: 'https://twitter.com/VELTRICKS',
    icon: (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Follow VELTRICKS on Instagram',
    href: 'https://instagram.com/VELTRICKS',
    icon: (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className="relative bg-bg-surface border-t border-border-subtle">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <a
              ...
              aria-label="VELTRICKS — Back to top"
            >
          ...
          <div>
            ...
            <ul className="space-y-2 mb-5">
              <li>
                <a href="mailto:hello@VELTRICKS.dev" className="text-text-muted text-sm hover:text-brand-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary rounded">
                  hello@VELTRICKS.dev
                </a>
              </li>
              <li>
                <a href="tel:+919876543210" className="text-text-muted text-sm hover:text-brand-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary rounded">
                  +91 98765 43210
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-6 border-t border-border-subtle flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-text-muted">
          <p>© {year} VELTRICKS. All rights reserved.</p>
