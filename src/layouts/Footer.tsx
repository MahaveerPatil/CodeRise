...
const socialLinks = [
  {
    label: 'Follow VELTRIX on LinkedIn',
  ...
  {
    label: 'Follow VELTRIX on GitHub',
    href: 'https://github.com/veltrix',
    icon: (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Follow VELTRIX on Twitter/X',
    href: 'https://twitter.com/veltrix',
    icon: (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Follow VELTRIX on Instagram',
    href: 'https://instagram.com/veltrix',
    icon: (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className="relative bg-bg-surface border-t border-border-subtle">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <a
              ...
              aria-label="VELTRIX — Back to top"
            >
          ...
          <div>
            ...
            <ul className="space-y-2 mb-5">
              <li>
                <a href="mailto:hello@veltrix.dev" className="text-text-muted text-sm hover:text-brand-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary rounded">
                  hello@veltrix.dev
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-6 border-t border-border-subtle flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-text-muted">
          <p>© {year} VELTRIX. All rights reserved.</p>
